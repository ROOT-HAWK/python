...
class config:
        key = "a2da9fcba148fea8973d032916b14e4b" #go to https://numverify.com/
...
def main():
        ...
        if len(sys.argv) == 2:
                ...
                print(color.YELLOW + "tracker >> " + color.END + "Phone number information gathering")
                print("--------------------------------------")
                time.sleep(0.2)
